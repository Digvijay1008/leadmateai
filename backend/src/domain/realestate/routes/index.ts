...
import propertiesRouter from './v1/properties.js';
import propertyProjectsRouter from './v1/property-projects.js';
import propertyDocumentsRouter from './v1/property-documents.js';
import leadsRouter from './v1/leads.js';
import searchRouter from './v1/search.js';
import embeddingsRouter from './v1/embeddings.js';
import semanticSearchRouter from './v1/semantic-search.js';
...
// Properties
router.use('/v1/properties', propertiesRouter);
router.use('/v1/property-projects', propertyProjectsRouter);
router.use('/v1/properties', propertyDocumentsRouter);
...
// Semantic Search
router.use('/v1/search', semanticSearchRouter);
